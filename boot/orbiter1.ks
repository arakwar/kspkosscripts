...
set startAngle to 84.
set targetOrbit to 80000.

UNTIL SHIP:ORBIT:APOAPSIS > targetOrbit*1.002 {
    set _heading to startAngle-(ship:orbit:apoapsis/(targetOrbit*1.2))^2*startAngle.
    print "Angle : " at (0,12).
...
wait until manoeuver:eta < 0.3*burnDuration.

lock throttle to 1.0.
wait until manoeuver:deltav:mag < 10.
lock throttle to 0.0.
